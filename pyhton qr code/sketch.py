...
# siapkan 1 gambar di folder yng sama untuk diconvert menjadi sketsa pensil
...
img = "python.jpg" # nama file input
...
def dodge(front,back):
    ...
    #kalau gambarnya lebih besar dari 255 bit/px maka akan disconvert jadi 255
    final_sketch[final_sketch>255]=255
    final_sketch[back==255]=255

    return final_sketch.astype('uint8')

#untuk read gambar yang dipilih diawal taadi
